...
<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#overview" style="text-decoration=none; color:#FBFCFC;"> Overview </a> </h3>

<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#system-basics" style="text-decoration=none; color:#FBFCFC;"> System Basics </a> </h3>

* [Logging In](#logging-in)
* [Working on the Command Line](#working-on-the-command-line)

<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#submitting-a-batch-job" style="text-decoration=none; color:#FBFCFC;"> Submitting a Batch Job </a> </h3>
...
<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#interactive-vs-batch" style="text-decoration=none; color:#FBFCFC;"> Interactive vs. Batch </a> </h3>

<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#accessing-software" style="text-decoration=none; color:#FBFCFC;"> Accessing Software </a> </h3>

<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#open-ondemand" style="text-decoration=none; color:#FBFCFC;"> Open OnDemand </a> </h3>

<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#testing-your-knowledge" style="text-decoration=none; color:#FBFCFC;"> Testing Your Knowledge </a> </h3>

<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#getting-help" style="text-decoration=none; color:#FBFCFC;"> Getting Help </a> </h3>

<h3 style="color:#FBFCFC; background-color:#262626;"> <a href="#community-events" style="text-decoration=none; color:#FBFCFC;"> Community Events </a> </h3>
...
<img src="ood_shell_access.png" alt="ood_shell_access" style="margin: 3px 12px 3px 0px; box-shadow: 10px 10px 5px grey;" width="786"/>
